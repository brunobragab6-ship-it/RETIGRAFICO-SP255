...
import { BarChart3, Upload, Table2, Map, Link2, ClipboardCheck, FileSpreadsheet } from "lucide-react";
...
export default function Shell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app"><aside>
    ...
    <div className="sidefoot">Araraquara - Bocaina<br />Kartado → Retigráfico → Medição<br /><b>v0.3.1 · Recursos contratuais + preços automáticos</b></div>
